#==============================================================================
# nfx-json - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_JSON_PACKAGE_SOURCE
        AND NOT NFX_JSON_PACKAGE_ARCHIVE
        AND NOT NFX_JSON_PACKAGE_DEB
        AND NOT NFX_JSON_PACKAGE_RPM)
    return()
endif()
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "Modern C++20 JSON library with schema validation and generation")
set(CPACK_PACKAGE_HOMEPAGE_URL          ${CMAKE_PROJECT_HOMEPAGE_URL})
set(CPACK_PACKAGE_INSTALL_DIRECTORY     "nfx")
set(CPACK_PACKAGE_CHECKSUM              "SHA256")
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_JSON_LICENSE_FILE})
...
# --- Advanced settings ---
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-json")
...
if(NOT DEFINED CPACK_GENERATOR)
    ...
    # --- DEB packages ---
    if(NFX_JSON_PACKAGE_DEB AND UNIX AND NOT APPLE)
        if(DPKG_CMD)
    ...
    # --- RPM packages ---
    if(NFX_JSON_PACKAGE_RPM AND UNIX AND NOT APPLE)
        if(RPM_CMD)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
    ...
    set(CPACK_RPM_PACKAGE_LICENSE      ${NFX_JSON_LICENSE})
